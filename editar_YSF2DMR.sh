...
clear
                    ...
                    tg=$(awk "NR==23" /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini)
                    sed -i "26c $tg" /home/ORANGEPIpi/info_panel_control.ini
                    master=$(awk "NR==26" /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini)
...
var1= sed -n 2p  /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini;

echo -n "\33[1;36m   2)\33[0m Modificar TXFrequency - \33[1;33m"
var2= sed -n 3p  /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini;

echo -n "\33[1;36m   3)\33[0m Latitud               - \33[1;33m"
var3= sed -n 5p  /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini;

echo -n "\33[1;36m   4)\33[0m Longitud              - \33[1;33m"
var4= sed -n 6p  /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini;

echo -n "\33[1;36m   5)\33[0m Modificar Location    - \33[1;33m"
var5= sed -n 8p  /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini;

echo -n "\33[1;36m   6)\33[0m Modificar URL         - \33[1;33m"
var6= sed -n 10p  /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini;

echo -n "\33[1;36m   7)\33[0m Modificar indicativo  - \33[1;33m"
var7= sed -n 13p  /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini;

echo -n "\33[1;36m   8)\33[0m DstPort               - \33[1;33m"
var=`grep -n -m 1 '\<DstPort\>' /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini`
var1=`grep -m 1 '\<DstPort\>' /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini`
buscar=":"
largo_linea=`expr index $var $buscar`
largo_linea=`expr $largo_linea - 1`
numero_linea=`expr substr $var 1 $largo_linea`
DstPort=$(awk "NR==$numero_linea" /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini)
letra=c
linea_sed_8=$numero_linea$letra
echo "$var1"

echo -n "\33[1;36m   9)\33[0m LocalPort             - \33[1;33m"
var=`grep -n -m 1 '\<LocalPort\>' /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini`
var1=`grep -m 1 '\<LocalPort\>' /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini`
buscar=":"
largo_linea=`expr index $var $buscar`
largo_linea=`expr $largo_linea - 1`
numero_linea=`expr substr $var 1 $largo_linea`
LocalPort=$(awk "NR==$numero_linea" /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini)
letra=c
linea_sed_9=$numero_linea$letra
echo "$var1"

echo -n "\33[1;36m  10)\33[0m Id                    - \33[1;33m"
idd1=`grep -n -m 1 "^Id=" /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini`
buscar=":"
caracteres=`expr index $idd1 $buscar`
caracteres_linea=`expr $caracteres - 1`
numero_linea_idd=`expr substr $idd1 1 $caracteres_linea`
idd1=$(awk "NR==$numero_linea_idd" /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini)
letra=c
linea_sed_10=$numero_linea_idd$letra
echo "$idd1"

echo -n "\33[1;36m  11)\33[0m StartupDstId          - \33[1;33m"
var=`grep -n -m 1 '\<StartupDstId\>' /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini`
var1=`grep -m 1 '\<StartupDstId\>' /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini`
buscar=":"
largo_linea=`expr index $var $buscar`
largo_linea=`expr $largo_linea - 1`
numero_linea=`expr substr $var 1 $largo_linea`
StartupDstId=$(awk "NR==$numero_linea" /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini)
letra=c
...
StartupPC=$(awk "NR==$numero_linea" /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini)
letra=c
linea_sed_12=$numero_linea$letra
echo "$StartupPC"

echo -n "\33[1;36m  13)\33[0m Address               - \33[1;33m"
var=`grep -n -m 1 '\<Address\>' /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini`
var1=`grep -m 1 '\<Address\>' /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini`
buscar=":"
largo_linea=`expr index $var $buscar`
largo_linea=`expr $largo_linea - 1`
numero_linea=`expr substr $var 1 $largo_linea`
Address=$(awk "NR==$numero_linea" /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini)
letra=c
...
Port=$(awk "NR==$numero_linea" /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini)
letra=c
linea_sed_14=$numero_linea$letra
echo "$Port"

echo -n "\33[1;36m  15)\33[0m Password              - \33[1;33m"
var=`grep -n -m 1 '\<Password\>' /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini`
var1=`grep -m 1 '\<Password\>' /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini`
buscar=":"
largo_linea=`expr index $var $buscar`
largo_linea=`expr $largo_linea - 1`
numero_linea=`expr substr $var 1 $largo_linea`
Password=$(awk "NR==$numero_linea" /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini)
letra=c
...
reflector=`grep -n -m 1 '\<Address\>' /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini_copia_01`
...
reflector=`grep -n -m 1 '\<Address\>' /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini_copia_02`
reflector=`expr substr $reflector 12 40`
echo "$reflector"
...
reflector=`grep -n -m 1 '\<Address\>' /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini_copia_03`
reflector=`expr substr $reflector 12 40`
echo "$reflector"
...
reflector=`grep -n -m 1 '\<Address\>' /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini_copia_04`
reflector=`expr substr $reflector 12 40`
echo "$reflector"
...
echo "Valor actual Indicativo: \33[1;33m${ind#*=}\33[1;37m"
           	          read -p 'Introduce tu indicativo: ' indicativo
                          ...
                          sed -i "$linea Callsign=$indicativo" /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
while true
do
                          rxf=`grep -n "RXFrequency" /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini`
                          ...
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "2c RXFrequency=$rx" /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
do
                          ...
                          txf=`grep -n "TXFrequency" /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini`
                          ...
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "3c TXFrequency=$tx" /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
do
                          ...
                          lat=`grep -n "Latitude" /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini`
                          ...
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "5c Latitude=$lat" /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
do
                          ...
                          lonng=`grep -n "Longitude" /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini`
                          ...
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "6c Longitude=$lon" /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
do
                          ...
                          lat=`grep -n "Location" /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini`
                          ...
                          sed -i "8c Location=$loc1" /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
do
                          ...
                          lonng=`grep -n "URL" /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini`
                          ...
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "10c URL=$lon" /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
do
                          ...
                          lonng=`grep -n "Callsign" /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini`
                          ...
                          sed -i "13c Callsign=$lonM" /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
do
                          ...
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "$linea_sed_8 DstPort=$lon" /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
do
                          ...
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "$linea_sed_9 LocalPort=$lon" /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
do                         
                          ...
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "$linea_sed_10 Id=$lon" /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
do
                          ...
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "$linea_sed_11 StartupDstId=$lon" /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
do
                          ...
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "$linea_sed_12 StartupPC=$lon" /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
do                      
                          ...
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "$linea_sed_13 Address=$lon" /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
do                      
                          ...
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "$linea_sed_14 Port=$lon" /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
do                      
                          ...
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "$linea_sed_15 Password=$lon" /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
do                
                        ...
                        sleep 3
                        sudo cp -f /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini_copia_01
                        break;;
                        [nN]* ) echo ""
                        break;;
esac
...
do
                        ...
                        sleep 3
                        sudo cp -f /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini_copia_01 /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini
                        break;;
                        [nN]* ) echo ""
                        break;;
esac
...
do                
                        ...
                        sleep 3
                        sudo cp -f /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini_copia_02
                        break;;
                        [nN]* ) echo ""
                        break;;
esac
...
do
                        ...
                        sleep 3
                        sudo cp -f /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini_copia_02 /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini
                        break;;
                        [nN]* ) echo ""
                        break;;
esac
...
do                
                        ...
                        sleep 3
                        sudo cp -f /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini_copia_03
                        break;;
                        [nN]* ) echo ""
                        break;;
esac
...
do
                        ...
                        sleep 3
                        sudo cp -f /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini_copia_03 /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini
                        break;;
                        [nN]* ) echo ""
                        break;;
esac
...
do                
                        ...
                        sleep 3
                        sudo cp -f /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini_copia_04
                        break;;
                        [nN]* ) echo ""
                        break;;
esac
...
do
                        ...
                        sleep 3
                        sudo cp -f /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini_copia_04 /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini
                        break;;
                        [nN]* ) echo ""
                        break;;
esac
...
do
                              ...
                              case $actualizar in
                              [sS]* ) echo ""
                              sudo pluma /home/ORANGEPIpi/YSF2DMR/YSF2DMR.ini
                              break;;
                              [nN]* ) echo ""
                              break;;
esac
