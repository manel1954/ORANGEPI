...
echo -n "                                            - "
var1= sed -n '4p'  /home/ORANGEPIpi/bluedv/BlueDVconfig.ini
echo ""
...
do
                        ...
                        case $act in
		            [sS]* ) echo ""
                        sed -i "4c comport=/dev/ttyACM0" /home/ORANGEPIpi/bluedv/BlueDVconfig.ini
		            break;;
		            [nN]* ) echo ""
		            break;;
esac
...
do
                        ...
                        case $act in
		            [sS]* ) echo ""
                        sed -i "4c comport=/dev/ttyACM1" /home/ORANGEPIpi/bluedv/BlueDVconfig.ini
		            break;;
		            [nN]* ) echo ""
		            break;;
esac
...
do          	          
                        ...
                        case $act in
		            [sS]* ) echo ""
                        sed -i "4c comport=/dev/ttyUSB0" /home/ORANGEPIpi/bluedv/BlueDVconfig.ini
		            break;;
		            [nN]* ) echo ""
		            break;;
esac
...
do
                        ...
                        case $act in
		            [sS]* ) echo ""
                        sed -i "4c comport=/dev/ttyUSB1" /home/ORANGEPIpi/bluedv/BlueDVconfig.ini
		            break;;
		            [nN]* ) echo ""
		            break;;
esac
...
do
                              ...
                              case $actualizar in
                                    [sS]* ) echo ""
                              pluma /home/ORANGEPIpi/bluedv/BlueDVconfig.ini
                                    break;;
                                    [nN]* ) echo ""
                                    break;;
esac
