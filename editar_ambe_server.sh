...
var1= sed -n '1p'  /home/ORANGEPIpi/ambe_server.ini

echo -n "\33[1;36m   2)\33[0m Modificar puerto MODEM   - \33[1;33m"
var1= sed -n '2p'  /home/ORANGEPIpi/ambe_server.ini

echo -n "\33[1;36m   3)\33[0m Modificar Baut rate      - \33[1;33m"
var1= sed -n '3p'  /home/ORANGEPIpi/ambe_server.ini
...
do
                    ...
                    sed -i "1c $pruter" /home/ORANGEPIpi/ambe_server.ini
			     break;;
			     [nN]* ) echo ""
			     break;;
esac
...
do
                    ...
                    sed -i "2c $pruter" /home/ORANGEPIpi/ambe_server.ini
                    break;;
                    [nN]* ) echo ""
                    break;;
esac
...
do
                    ...
                    echo "${CIAN}"
                    read -p 'Introduce puerto MODEM:        ' pruter
                    sed -i "3c $pruter" /home/ORANGEPIpi/ambe_server.ini
                    break;;
                    [nN]* ) echo ""
                    break;;
esac
