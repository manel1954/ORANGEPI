...
do
clear
#SCRIPTS_version=$(awk "NR==1" /home/ORANGEPIpi/.config/autostart/version)
ROJO="\033[1;31m"
VERDE="\033[1;32m"
BLANCO="\033[1;37m"
AMARILLO="\033[1;33m"
...
echo -n "${BLANCO}   "
tac $(ls -1rt /home/ORANGEPIpi/MMDVMHost/MMDVM-*.log | tail -n1 ) | grep "protocol" -m 1 | sed -n 's/description: /&\n/;s/.*\n//p'
...
clear
                        ...
                        sudo pluma /home/ORANGEPIpi/MMDVM_HS/Config.h
echo "${ROJO}"
echo "   ******************************"
echo "   *                            *"
echo "   *        COMPILANDO          *"
...
clear
                        ...
                        [sS]* ) echo ""
                        echo ""
                        cd /home/ORANGEPIpi/MMDVM_HS/
                        cp /home/ORANGEPIpi/ORANGEPI/install_fw_librekit.sh /home/ORANGEPIpi/MMDVM_HS/bin/
                        cd /home/ORANGEPIpi/MMDVM_HS/bin
                        sleep 2
