...
echo "{$CIAN}"
mate-terminal --geometry 67x30+22+50 --title=SVXLINK -x sudo svxlink

sed -i "6c Exec=mate-terminal --geometry 70x33+22+50 --title=SVXLINK -x sh ejecutar_svxlink_05.sh" /home/orangepi/Desktop/Abrir_SVXLink.desktop
