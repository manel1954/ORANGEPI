...
echo "{$CIAN}"
mate-terminal --geometry 68x29+22+50 --title=SVXLINK -x sudo svxlink
#sudo svxlink
sed -i "6c Exec=mate-terminal --geometry 68x29+22+50 --title=SVXLINK -x sudo svxlink" /home/orangepi/Desktop/Abrir_SVXLink.desktop
