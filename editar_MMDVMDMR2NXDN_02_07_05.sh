...
url=`grep -n "URL" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini`
...
txinv=`grep -n '\<TXInvert\>' /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini`
txinv1=`expr substr $txinv 4 30`
echo -n "$txinv1"

echo -n "\33[1;36m      a)\33[0m D-STAR      - \33[1;33m"
dstar=`grep -n "\[D-Star\]" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini` # devuelve ejem: 74:Enable=1
buscar=":"
...
presentar_valo= sed -n $numero_linea_dstar_letrap  /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini; #presenta el valor en pantalla

echo -n "\33[1;36m  15)\33[0m Modificar RXLevel     - \33[1;33m"
rx=`grep -n '\<RXLevel\>' /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini`
rx1=`expr substr $rx 4 30`
echo -n "$rx1"

echo -n "\33[1;36m      b)\33[0m DMR         - \33[1;33m"
dmr=`grep -n "\[DMR\]" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini` # devuelve ejem: 74:Enable=1
buscar=":"
...
presentar_valor= sed -n $numero_linea_dmr_letrap  /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini; #presenta el valor en pantalla

echo -n "\33[1;36m  16)\33[0m Modificar TXLevel     - \33[1;33m"
tx=`grep -n -m 1 '\<TXLevel\>' /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini`
tx1=`expr substr $tx 4 30`
echo -n "$tx1"

echo -n "\33[1;36m      c)\33[0m FUSION      - \33[1;33m"
fusion=`grep -n "LowDeviation" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini` # devuelve ejem: 74:Enable=1
buscar=":"
...
presentar_valor= sed -n $numero_linea_fusion_letrap  /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini; #presenta el valor en pantalla

echo -n "\33[1;36m  17)\33[0m Modificar Duplex      - \33[1;33m"
dup=`grep -n -m 1 '\<Duplex\>' /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini`
...
presentar_valor= sed -n $numero_linea_p25_letrap  /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini; #presenta el valor en pantalla

echo -n "\33[1;36m  18)\33[0m Modificar TXHang      - \33[1;33m"
txh=`grep -n -m 1 '\<TXHang\>' /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini`
txh1=`expr substr $txh 5 30`
echo -n "$txh1"

echo -n "\33[1;36m        e)\33[0m Baliza      - \33[1;33m"
cw= sed -n "31p"  /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini; #presenta el valor en pantalla

echo -n "\33[1;36m  19)\33[0m Modificar Tramas      - \33[1;33m"
lg=`grep -n -m 1 '\<DisplayLevel\>' /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini`
lg1=`expr substr $lg 4 30`
echo -n "$lg1"

echo -n "\33[1;36m  f)\33[0m RFModeHang  - \33[1;33m"
modehang=`grep -n -m 1 -c '\<RFModeHang\>' /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini`
if [ $modehang = 0 ]; then
echo "\33[1;31mEsta versión MMDVMHost no trae este parámetro"
else
modehang=`grep -n -m 1 '\<RFModeHang\>' /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini`
modehang1=`expr substr $modehang 3 30`
echo "$modehang1"
fi

echo -n "\33[1;36m  20)\33[0m Modificar Slot1       - \33[1;33m"
sl=`grep -n -m 1 '\<Slot1\>' /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini`
sl1=`expr substr $sl 5 30`
echo -n "$sl1"

echo -n "\33[1;36m         g)\33[0m Timeout     - \33[1;33m"
timeo=`grep -n -m 1 -c '\<Timeout\>' /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini`
if [ $timeo = 0 ]; then
echo "\33[1;31mEsta versión MMDVMHost no trae este parámetro"
else
timeo=`grep -n -m 1 '\<Timeout\>' /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini`
timeo1=`expr substr $timeo 3 30`
echo "$timeo1"
fi

echo -n "\33[1;36m  21)\33[0m Tipo Pantalla Display - \33[1;33m"
Display=`grep -n -m 1 -c '\<Display\>' /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini`
if [ $Display = 0 ]; then
echo "\33[1;31mEsta versión MMDVMHost no trae este parámetro"
else
Display=`grep -n -m 1 '\<Display\>' /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini`
...
MODEMNEXTION=$(awk "NR==$numero_linea" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini)
letra=c
...
ScreenLayout=`grep -n -m 1 -c '\<ScreenLayout\>' /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini`
if [ $ScreenLayout = 0 ]; then
echo "\33[1;31mEsta versión MMDVMHost no trae este parámetro"
else
ScreenLayout=`grep -n -m 1 '\<ScreenLayout\>' /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini`
ScreenLayout1=`expr substr $ScreenLayout 5 30`
echo -n "$ScreenLayout1"
fi

var=`grep -n -m 1 "\[NXDN\]" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini`
buscar=":"
largo_linea=`expr index $var $buscar`
largo_linea=`expr $largo_linea - 1`
numero_linea=`expr substr $var 1 $largo_linea`
numero_linea=`expr $numero_linea + 1` # Se le suma 1 al número de linea
NXDN=$(awk "NR==$numero_linea" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini)
letra=c
...
Brightness=`grep -n -m 1 -c '\<Brightness\>' /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini`
if [ $Brightness = 0 ]; then
echo "\33[1;31mEsta versión MMDVMHost no trae este parámetro"
else
Brightness=`grep -n -m 1 '\<Brightness\>' /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini`
Brightness1=`expr substr $Brightness 5 30`
echo -n "$Brightness1"
fi

# j) POCSAG Enable=
var=`grep -n -m 1 "\[POCSAG\]" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini`
buscar=":"
largo_linea=`expr index $var $buscar`
largo_linea=`expr $largo_linea - 1`
numero_linea=`expr substr $var 1 $largo_linea`
numero_linea=`expr $numero_linea + 1` # Se le suma 1 al número de linea
POCSAG=$(awk "NR==$numero_linea" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini)
letra=c
...
lat=`grep -n "Latitude" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini`
lat1=`expr substr $lat 4 30`
echo "$lat1"

echo -n "\33[1;36m  25)\33[0m Coordenada Longitud   - \33[1;33m"
long=`grep -n "Longitude" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini`
long1=`expr substr $long 4 30`
echo "$long1"

echo -n "\33[1;36m  26)\33[0m Modulo D-STAR         - \33[1;33m"
modu=`grep -n -m 1 '\<Module\>' /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini`
...
Local=$(awk "NR==$numero_linea" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini)
letra=c
linea_sed_29=$numero_linea$letra
echo "$Local"

echo ""
var1=`grep -n "\[DMR Network\]" /home/orangepi/DMR2NXDN/DMR2NXDN.ini` 
var=`echo "$var1" | tr -d '[[:space:]]'`
buscar=":"
largo_linea=`expr index $var $buscar`
largo_linea=`expr $largo_linea - 1`
...
Local=$(awk "NR==$numero_linea" /home/orangepi/DMR2NXDN/DMR2NXDN.ini)
letra=c
linea_sed_10=$numero_linea$letra
echo "  ${ROJO}PARAMETROS DMR2NXDN.ini "
echo "  ${CIAN}10)${GRIS} Modificar Id          - ${VERDE}$Local"

indi=$(awk "NR==2" /home/orangepi/NXDNClients/NXDNGateway/NXDNGateway.ini)
echo "  ${ROJO}PARAMETROS NXDNGateway.ini "
echo "  ${CIAN} 1)${GRIS} Modificar Indicativo  - ${VERDE}$indi"

rxf=$(awk "NR==11" /home/orangepi/NXDNClients/NXDNGateway/NXDNGateway.ini)
echo "  ${CIAN} 2)${GRIS} Modificar RXFrequency - ${VERDE}$rxf"

txf=$(awk "NR==12" /home/orangepi/NXDNClients/NXDNGateway/NXDNGateway.ini)
echo "  ${CIAN} 3)${GRIS} Modificar TXFrequency - ${VERDE}$txf"

echo -n " ${CIAN} 30)${GRIS} Modificar Daemon      - ${VERDE}"
dae=$(awk "NR==8" /home/orangepi/NXDNClients/NXDNGateway/NXDNGateway.ini)
echo "$dae"

echo -n " ${CIAN} 31)${GRIS} Sala NXDN a conectar  - ${VERDE}"
var=`grep -n -m 1 '\<Startup\>' /home/orangepi/NXDNClients/NXDNGateway/NXDNGateway.ini`
buscar=":"
largo_linea=`expr index $var $buscar`
largo_linea=`expr $largo_linea - 1`
numero_linea=`expr substr $var 1 $largo_linea`
sala=$(awk "NR==$numero_linea" /home/orangepi/NXDNClients/NXDNGateway/NXDNGateway.ini)
letra=c
linea_sed_31=$numero_linea$letra
echo "$sala"

echo -n " ${CIAN} 32)${GRIS} InactivityTimeout     - ${VERDE}"
var=`grep -n -m 1 '\<InactivityTimeout\>' /home/orangepi/NXDNClients/NXDNGateway/NXDNGateway.ini`
buscar=":"
largo_linea=`expr index $var $buscar`
largo_linea=`expr $largo_linea - 1`
numero_linea=`expr substr $var 1 $largo_linea`
Inact=$(awk "NR==$numero_linea" /home/orangepi/NXDNClients/NXDNGateway/NXDNGateway.ini)
letra=c
...
sed -i "$linea Callsign=$indicativo" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini
sed -i "2c Callsign=$indicativo" /home/orangepi/NXDNClients/NXDNGateway/NXDNGateway.ini
indi=$(awk "NR==2" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini)
...
echo "Valor actual del RXFrequency: \33[1;33m${rxf#*=}\33[1;37m"
           	          ...
           	          read -p 'Introduce RXFrequency:        ' var2
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                              sed -i "13c RXFrequency=$var2" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini

frec=$(awk "NR==13" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini)
sed -i "11c RXFrequency=$var2" /home/orangepi/NXDNClients/NXDNGateway/NXDNGateway.ini
...
echo "Valor actual del TXFrequency: \33[1;33m${txf#*=}\33[1;37m"
           	          ...
           	          read -p 'Introduce TXFrequency:        ' var2
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "14c TXFrequency=$var2" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini
                          sed -i "12c TXFrequency=$var2" /home/orangepi/NXDNClients/NXDNGateway/NXDNGateway.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor de la Ciudad: \33[1;33m${loca#*=}\33[1;37m"
              ...
              sed -i "$linea Location=$loc1" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor de  la  URL   Web: \33[1;33m${url#*=}\33[1;37m"
			  ...
			  ur1=`echo "$ur1" | tr -d '[[:space:]]'`
                          sed -i "$linea URL=$ur1" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
                          ...
                          sed -i "$numero_linea_port Port=/dev/ttyS3" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
                          ...
                          letrac=c
                          numero_linea_port=$numero_linea_port$letrac
                          sed -i "$numero_linea_port Port=/dev/ttyACM0" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
                          ...
                          letrac=c
                          numero_linea_port=$numero_linea_port$letrac
                          sed -i "$numero_linea_port Port=/dev/ttyACM1" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
                          ...
                          letrac=c
                          numero_linea_port=$numero_linea_port$letrac
                          sed -i "$numero_linea_port Port=/dev/ttyUSB0" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor  actual  del Id: \33[1;33m${idd#*=}\33[1;37m"
           	          read -p 'Introduce un ID válido ' miid
                          ...
                          case $actualizar in
			                    [sS]* ) echo ""
                          sed -i "3c Id=$miid" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini
                          sed -i "$linea_sed_10 Id=$miid" /home/orangepi/DMR2NXDN/DMR2NXDN.ini

                          ide=$(awk "NR==3" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini)
...
master1=`echo "$master1" | tr [:upper:] [:lower:]`
                          ...
                          sed -i "$linea_master Address=$master1" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini

master=$(awk "NR==139" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini)
...
do
        ...
        [sS]* ) echo ""
                          ...
                          sed -i "$linea4 Port=$miid" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini
        break;;
        [nN]* ) echo ""
        break;;
esac
...
do
           	          ...
           	          read -p '   Introduce el password que corresponda: ' pas1
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "234c Password=$pas1" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor  actual del  TXInvert: \33[1;33m${txinv#*=}\33[1;37m"
                         ...
                         if [ $largo = 3 ]
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea TXInvert=$txinv1" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor  actual  del  RXLevel : \33[1;33m${rx#*=}\33[1;37m"
           	          read -p 'Valor óptimo para DVMEGA=45 : ' var2
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea RXLevel=$var2" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor  actual  del  TXLevel : \33[1;33m${tx#*=}\33[1;37m"
           	          read -p 'Valor óptimo para DVMEGA=50 : ' var2
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea TXLevel=$var2" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor actual del Duplex: \33[1;33m${dup#*=}\33[1;37m"
           	          read -p 'Para un repetidor Duplex=1 Para un DVMEGA Duplex=0: ' dup1
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea Duplex=$dup1" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor actual del TXHang: \33[1;33m${txh#*=}\33[1;37m"
           	          read -p 'Para un repetidor TXHang=4 Para un DVMEGA TXHang=0: ' txh1
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea TXHang=$txh1" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor actual del DisplayLevel: \33[1;33m${lg#*=}\33[1;37m"
           	     read -p 'Para visualizar tramas seguidas introduce 1, para una sola trama introduce 2:' lg1
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea DisplayLevel=$lg1" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
while true
do
sl=`grep -n -m 1 -c '\<Slot1\>' /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini`
if [ $sl = 0 ]; then
...
echo "Valor actual del Slot1=: \33[1;33m${sl#*=}\33[1;37m"
           	          read -p 'Para DVMEGA Modificar el valor del Slot1=0: ' V
			              ...
			              [sS]* ) echo ""
			              V=`echo "$V" | tr -d '[[:space:]]'`			  
                          sed -i "$linea Slot1=$V" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini             
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor actual del Display=: \33[1;33m${Display1#*=}\33[1;37m"
                    ...
                    [sS]* ) echo ""
                    V=`echo "$V" | tr -d '[[:space:]]'`       
                          sed -i "$linea Display=$V" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini             
        break;;
        [nN]* ) echo ""
        break;;
esac
...
echo "Valor actual del ScreenLayout=: \33[1;33m${ScreenLayout1#*=}\33[1;37m"
                    ...
                    [sS]* ) echo ""
                    V=`echo "$V" | tr -d '[[:space:]]'`       
                          sed -i "$linea ScreenLayout=$V" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini             
        break;;
        [nN]* ) echo ""
        break;;
esac
...
echo "Valor  actual  del Brightness : \33[1;33m${Brightness1#*=}\33[1;37m"
                    ...
                    [sS]* ) echo ""
                    V=`echo "$V" | tr -d '[[:space:]]'`       
                          sed -i "$linea Brightness=$V" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini             
        break;;
        [nN]* ) echo ""
        break;;
esac
...
modu1=`echo "$modu1" | tr [:lower:] [:upper:]`
                          ...
                          sed -i "$linea Module=$modu1" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
                          ...
                          presenta_valor= sed -n $numero_linea_dstar_letrap  /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini;
                          read -p 'Desactivado=0 Activado=1:  '   dmrac1
                          actualizar=S 
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "$numero_linea_dstar_letrac Enable=$dmrac1" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
do
                          ...
                          presenta_valor= sed -n $numero_linea_dmr_letrap  /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini;
           	              read -p 'Desactivado=0 Activado=1: '   dmrac1
                          actualizar=S 
                          case $actualizar in
			                    [sS]* ) echo ""
                          sed -i "$numero_linea_dmr_letrac Enable=$dmrac1" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini
			                    break;;
			                    [nN]* ) echo ""
			                    break;;
esac
...
do
                          ...
                          presenta_valor= sed -n $numero_linea_fusion_letrap  /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini;
                          read -p 'Desactivado=0 Activado=1:  '   dmrac1
                          actualizar=S 
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "$numero_linea_fusion_letrac Enable=$dmrac1" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
do
                          ...
                          presenta_valor= sed -n $numero_linea_p25_letrap  /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini;
                          read -p 'Desactivado=0 Activado=1: '   dmrac1
                          actualizar=S 
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "$numero_linea_p25_letrac Enable=$dmrac1" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
echo "Valor actual del RFModeHang = : \33[1;33m${modehang1#*=}\33[1;37m"
                    ...
                    [sS]* ) echo ""
                    V=`echo "$V" | tr -d '[[:space:]]'`       
                          sed -i "$linea RFModeHang=$V" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini             
        break;;
        [nN]* ) echo ""
        break;;
esac
...
echo "Valor actual del Timeout = : \33[1;33m${timeo1#*=}\33[1;37m"
                    ...
                    [sS]* ) echo ""
                    V=`echo "$V" | tr -d '[[:space:]]'`       
                          sed -i "$linea Timeout=$V" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini             
        break;;
        [nN]* ) echo ""
        break;;
esac
...
echo "Valor del Port: \33[1;33m$MODEMNEXTION"
                          ...
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "$linea_sed_MN Port=$lat1" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
echo "Valor actual NXDN: \33[1;33m$NXDN"
                          ...
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "$linea_sed_NXDN Enable=$NXDN1" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
do
                          ...
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "$linea_sed_POCSAG Enable=$POCSAG1" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
echo "Valor de la Latitud: \33[1;33m${lat#*=}\33[1;37m"
           	          read -p 'Introduce la Latitud ' lat1
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea Latitude=$lat1" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor de la Longitud: \33[1;33m${long#*=}\33[1;37m"
           	          read -p 'Introduce la Longitud ' long1
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea Longitude=$long1" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
			  ...
			  read -p 'Intruduce reflector DMR+ al que se conectara (ej:4374) ' opcion
                          sed -i "238c Options=StartRef=$opcion;RelinkTime=10;" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini
			  break;;
			  [nN]* ) echo ""
			  sed -i "238c #Options=StartRef=4370;RelinkTime=10;" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini
			  break;;
esac
done;;
28) echo ""
...
do
                              ...
                              case $actualizar in
			                        [sS]* ) echo ""
                              sudo pluma /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini
			                        break;;
			                        [nN]* ) echo ""
			                        break;;
esac
...
do
                          ...
                          sed -i "$linea_sed_29 Local=$dmrac1" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini
...
do
                          ...
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "8c Daemon=$dmrac1" /home/orangepi/NXDNClients/NXDNGateway/NXDNGateway.ini
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
do
                          ...
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "$linea_sed_31 Startup=$dmrac1" /home/orangepi/NXDNClients/NXDNGateway/NXDNGateway.ini
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
do
                          ...
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "$linea_sed_32 InactivityTimeout=$dmrac1" /home/orangepi/NXDNClients/NXDNGateway/NXDNGateway.ini
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
do
                          ...
                          mkdir private
                          cd /home/orangepi/V7
                          cp NXDNHosts.txt /home/orangepi/NXDNClients/NXDNGateway/private
                          cd /home/orangepi/NXDNClients/NXDNGateway/
                          rm NXDNHosts.txt
