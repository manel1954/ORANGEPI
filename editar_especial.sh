...
ind=`grep -n "Callsign" /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini`
ind1=`expr substr $ind 3 30`
echo "$ind1"

echo -n "\33[1;36m   2)\33[0m Modificar RXFrequency - \33[1;33m"
rxf=`grep -n "RXFrequency" /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini`
rxf1=`expr substr $rxf 4 30`
echo "$rxf1"

echo -n "\33[1;36m   3)\33[0m Modificar TXFrequency - \33[1;33m"
txf=`grep -n "TXFrequency" /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini`
txf1=`expr substr $txf 4 30`
echo "$txf1"

echo -n "\33[1;36m   4)\33[0m Modificar Location    - \33[1;33m"
loca=`grep -n "Locatio" /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini`
loca1=`expr substr $loca 4 30`
echo "$loca1"

echo -n "\33[1;36m   5)\33[0m Modificar URL         - \33[1;33m"
url=`grep -n "URL" /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini`
...
mode=`grep -n -m 1 '\<Modem\>' /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini`
...
letra=p
linea2=$linea$letra
var99= sed -n $linea2  /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini;

echo -n "\33[1;36m  10)\33[0m Modificar ID          - \33[1;33m"
idd=`grep -n "Id=" /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini`
idd1=`expr substr $idd 4 30`
echo "$idd1"

echo -n "\33[1;36m  11)\33[0m Modificar Address     - \33[1;33m"
master=`grep -n -m 1 '\<Address\>' /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini`
buscar=":"
...
var100port= sed -n $linea2port  /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini;

echo -n "\33[1;36m  13)\33[0m Modificar Password    - \33[1;33m"
pas=`grep -n '\<Password\>' /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini`
pas1=`expr substr $pas 4 30`
echo "$pas1"

echo -n "\33[1;36m  14)\33[0m Modificar TXInvert    - \33[1;33m"
txinv=`grep -n '\<TXInvert\>' /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini`
txinv1=`expr substr $txinv 4 30`
echo "$txinv1"

echo -n "\33[1;36m  15)\33[0m Modificar RXLevel     - \33[1;33m"
rx=`grep -n '\<RXLevel\>' /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini`
rx1=`expr substr $rx 4 30`
echo "$rx1"

echo -n "\33[1;36m  16)\33[0m Modificar TXLevel     - \33[1;33m"
tx=`grep -n -m 1 '\<TXLevel\>' /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini`
tx1=`expr substr $tx 4 30`
echo "$tx1"

echo -n "\33[1;36m  17)\33[0m Modificar Duplex      - \33[1;33m"
dup=`grep -n -m 1 '\<Duplex\>' /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini`
dup1=`expr substr $dup 3 30`
echo "$dup1"

echo -n "\33[1;36m  18)\33[0m Modificar Tramas      - \33[1;33m"
lg=`grep -n -m 1 '\<DisplayLevel\>' /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini`
lg1=`expr substr $lg 4 30`
echo "$lg1"

echo -n "\33[1;36m  19)\33[0m Modificar Slot1       - \33[1;33m"
sl=`grep -n -m 1 '\<Slot1\>' /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini`
sl1=`expr substr $sl 4 30`
echo "$sl1"

echo -n "\33[1;36m  20)\33[0m Modificar OscOffset   - \33[1;33m"
salto=`grep -n -m 1 -c '\<OscOffset\>' /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini`
if [ $salto = 0 ]; then
echo "\33[1;31mEsta versión MMDVMHost no trae este parámetro"
else
salto=`grep -n -m 1 '\<OscOffset\>' /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini`
salto1=`expr substr $salto 4 30`
echo "$salto1"
fi

echo -n "\33[1;36m  21)\33[0m Modulo D-STAR         - \33[1;33m"
modu=`grep -n -m 1 '\<Module\>' /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini`
...
letra=p
linea2=$linea$letra
var200= sed -n $linea2  /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini;

echo -n "\33[1;36m  23)\33[0m Coordenada Latitud    - \33[1;33m"
lat=`grep -n "Latitude" /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini`
lat1=`expr substr $lat 4 30`
echo "$lat1"

echo -n "\33[1;36m  24)\33[0m Coordenada Longitud   - \33[1;33m"
long=`grep -n "Longitude" /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini`
long1=`expr substr $long 4 30`
echo "$long1"

echo -n "\33[1;36m  25)\33[0m Modificar RXInvert    - \33[1;33m"
rxinv=`grep -n '\<RXInvert\>' /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini`
rxinv1=`expr substr $rxinv 4 30`
echo "$rxinv1"

echo ""
echo "\33[1;36m  26)\33[1;33m Abrir fichero MMDVMESPECIAL.ini para hacer cualquier cambio\33[1;33m"
...
reflector=`grep -n -m 1 '\<Address\>' /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini_uno`
...
reflector2=`grep -n -m 1 '\<Address\>' /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini_dos`
...
echo "Valor actual Indicativo: \33[1;33m${ind#*=}\33[1;37m"
           	          read -p 'Introduce tu indicativo: ' indicativo
                          ...
                          sed -i "$linea Callsign=$indicativo" /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor actual del RXFrequency: \33[1;33m${rxf#*=}\33[1;37m"
           	          ...
           	          read -p 'Introduce RXFrequency:        ' var2
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                              sed -i "$linea RXFrequency=$var2" /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini
			break;;
			[nN]* ) echo ""
			break;;
esac
...
echo "Valor actual del TXFrequency: \33[1;33m${txf#*=}\33[1;37m"
           	          ...
           	          read -p 'Introduce TXFrequency:        ' var2
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea TXFrequency=$var2" /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor de la Ciudad: \33[1;33m${loca#*=}\33[1;37m"
              ...
              sed -i "$linea Location=$loc1" /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor de  la  URL   Web: \33[1;33m${url#*=}\33[1;37m"
			  ...
			  ur1=`echo "$ur1" | tr -d '[[:space:]]'`
                          sed -i "$linea URL=$ur1" /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
			  ...
			  [sS]* ) echo ""
                          ...
                          sed -i "$linea4 Port=/dev/ttyS3" /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
			  ...
			  [sS]* ) echo ""
                          letra1=c
                          linea4=$linea33$letra1
                          sed -i "$linea4 Port=/dev/ttyACM0" /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
			  ...
			  [sS]* ) echo ""
                          letra1=c
                          linea4=$linea33$letra1
                          sed -i "$linea4 Port=/dev/ttyUSB0" /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
			  ...
			  [sS]* ) echo ""
                          letra1=c
                          linea4=$linea33$letra1
                          sed -i "$linea4 Port=/dev/ttyUSB1" /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor  actual  del Id: \33[1;33m${idd#*=}\33[1;37m"
           	          read -p 'Introduce un ID válido ' miid
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea Id=$miid" /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor actual del Master: \33[1;33m${master#*=}\33[1;37m"
                    ...
                    letra=c            
linea=$largo$letra
                          sed -i "$linea Address=$master1" /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
			  ...
			  [sS]* ) echo ""
                          ...
                          sed -i "$linea4 Port=$miid" /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "   Valor actual del Password: \33[1;33m${pas#*=}\33[1;37m"
           	          read -p '   Introduce el password que corresponda: ' pas1
                          ...
                          sed -i "$linea Password=$pas1" /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor  actual del  TXInvert: \33[1;33m${txinv#*=}\33[1;37m"
                         ...
                         if [ $largo = 3 ]
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea TXInvert=$txinv1" /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor  actual  del  RXLevel : \33[1;33m${rx#*=}\33[1;37m"
           	          read -p 'Valor óptimo para DVMEGA=45 : ' var2
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea RXLevel=$var2" /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor  actual  del  TXLevel : \33[1;33m${tx#*=}\33[1;37m"
           	          read -p 'Valor óptimo para DVMEGA=50 : ' var2
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea TXLevel=$var2" /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor actual del Duplex: \33[1;33m${dup#*=}\33[1;37m"
           	          read -p 'Para un repetidor Duplex=1 Para un DVMEGA Duplex=0: ' dup1
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea Duplex=$dup1" /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor actual del DisplayLevel: \33[1;33m${lg#*=}\33[1;37m"
           	     read -p 'Para visualizar tramas seguidas introduce 1, para una sola trama introduce 2:' lg1
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea DisplayLevel=$lg1" /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
sl=`grep -n -m 1 -c '\<Slot1\>' /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini`
if [ $sl = 0 ]; then
...
echo "Valor actual del Slot1=: \33[1;33m${sl#*=}\33[1;37m"
           	          read -p 'Para DVMEGA Modificar el valor del Slot1=0: ' V
			              ...
			              [sS]* ) echo ""
			              V=`echo "$V" | tr -d '[[:space:]]'`			  
                          sed -i "$linea Slot1=$V" /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini
...
echo "Valor  actual  del  scOffset : \33[1;33m${salto#*=}\33[1;37m"
                         ...
                         if [ $largo = 3 ]
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea OscOffset=$of1" /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor  actual  del  Module: \33[1;33m${modu#*=}\33[1;37m"
                         ...
                         if [ $largo = 3 ]
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea Module=$modu1" /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo -n "Valor  actual  del \33[1;33m${var200#*=}\33[1;37m"
                          var100= sed -n $linea2  /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini;
                          ...
                          sed -i "$linea4 Enable=$dmrac1" /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini
			              break;;
			              [nN]* ) echo ""
			              break;;
esac
...
echo "Valor de la Latitud: \33[1;33m${lat#*=}\33[1;37m"
           	          read -p 'Introduce la Latitud ' lat1
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea Latitude=$lat1" /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor de la Longitud: \33[1;33m${long#*=}\33[1;37m"
           	          read -p 'Introduce la Longitud ' long1
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea Longitude=$long1" /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor  actual del  RXInvert: \33[1;33m${rxinv#*=}\33[1;37m"
                      read -p 'Valor óptimo para Motorola=0 para otras=1 : ' rxinv11
                         ...
                         if [ $largo = 3 ]
                          ...
                          case $actualizar in
        [sS]* ) echo ""
                          sed -i "$linea RXInvert=$rxinv11" /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini
        break;;
        [nN]* ) echo ""
        break;;
esac
...
do
                              ...
                              case $actualizar in
			                        [sS]* ) echo ""
                              sudo pluma /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini
			                        break;;
			                        [nN]* ) echo ""
			                        break;;
esac
...
do
                        ...
                        sleep 3
                        sudo cp -f /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini_uno
                        break;;
                        [nN]* ) echo ""
                        break;;
esac
...
do
                        ...
                        sleep 3
                        sudo cp -f /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini_uno /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini
                        break;;
                        [nN]* ) echo ""
                        break;;
esac
...
do
                        ...
                        sleep 3
                        sudo cp -f /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini_dos
                        break;;
                        [nN]* ) echo ""
                        break;;
esac
...
do
                        ...
                        sleep 3
                        sudo cp -f /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini_dos /home/ORANGEPIpi/MMDVMHost/MMDVMESPECIAL.ini
                        break;;
                        [nN]* ) echo ""
                        break;;
esac
