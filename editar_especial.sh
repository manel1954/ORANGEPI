...
ind=`grep -n "Callsign" /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini`
...
loca=`grep -n "Locatio" /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini`
...
mode=`grep -n -m 1 '\<Modem\>' /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini`
...
letra=p
linea2=$linea$letra
var99= sed -n $linea2  /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini;
...
pas=`grep -n '\<Password\>' /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini`
...
salto=`grep -n -m 1 -c '\<OscOffset\>' /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini`
if [ $salto = 0 ]; then
echo "\33[1;31mEsta versión MMDVMHost no trae este parámetro"
else
salto=`grep -n -m 1 '\<OscOffset\>' /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini`
...
letra=p
linea2=$linea$letra
var200= sed -n $linea2  /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini;
...
rxinv=`grep -n '\<RXInvert\>' /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini`
...
reflector=`grep -n -m 1 '\<Address\>' /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini_uno`
...
reflector2=`grep -n -m 1 '\<Address\>' /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini_dos`
...
echo "Valor de la Ciudad: \33[1;33m${loca#*=}\33[1;37m"
              ...
              sed -i "$linea Location=$loc1" /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
			  ...
			  [sS]* ) echo ""
                          ...
                          sed -i "$linea4 Port=/dev/ttyS3" /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
			  ...
			  [sS]* ) echo ""
                          letra1=c
                          linea4=$linea33$letra1
                          sed -i "$linea4 Port=/dev/ttyACM0" /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
			  ...
			  [sS]* ) echo ""
                          letra1=c
                          linea4=$linea33$letra1
                          sed -i "$linea4 Port=/dev/ttyUSB0" /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
			  ...
			  [sS]* ) echo ""
                          letra1=c
                          linea4=$linea33$letra1
                          sed -i "$linea4 Port=/dev/ttyUSB1" /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor actual del Master: \33[1;33m${master#*=}\33[1;37m"
                    ...
                    letra=c            
linea=$largo$letra
                          sed -i "$linea Address=$master1" /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "   Valor actual del Password: \33[1;33m${pas#*=}\33[1;37m"
           	          read -p '   Introduce el password que corresponda: ' pas1
                          ...
                          sed -i "$linea Password=$pas1" /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor  actual  del  scOffset : \33[1;33m${salto#*=}\33[1;37m"
                         ...
                         if [ $largo = 3 ]
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea OscOffset=$of1" /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo -n "Valor  actual  del \33[1;33m${var200#*=}\33[1;37m"
                          var100= sed -n $linea2  /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini;
                          ...
                          sed -i "$linea4 Enable=$dmrac1" /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini
			              break;;
			              [nN]* ) echo ""
			              break;;
esac
...
echo "Valor  actual del  RXInvert: \33[1;33m${rxinv#*=}\33[1;37m"
                      read -p 'Valor óptimo para Motorola=0 para otras=1 : ' rxinv11
                         ...
                         if [ $largo = 3 ]
                          ...
                          case $actualizar in
        [sS]* ) echo ""
                          sed -i "$linea RXInvert=$rxinv11" /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini
        break;;
        [nN]* ) echo ""
        break;;
esac
...
do
                        ...
                        sleep 3
                        sudo cp -f /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini_uno
                        break;;
                        [nN]* ) echo ""
                        break;;
esac
...
do
                        ...
                        sleep 3
                        sudo cp -f /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini_uno /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini
                        break;;
                        [nN]* ) echo ""
                        break;;
esac
...
do
                        ...
                        sleep 3
                        sudo cp -f /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini_dos
                        break;;
                        [nN]* ) echo ""
                        break;;
esac
...
do
                        ...
                        sleep 3
                        sudo cp -f /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini_dos /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini
                        break;;
                        [nN]* ) echo ""
                        break;;
esac
